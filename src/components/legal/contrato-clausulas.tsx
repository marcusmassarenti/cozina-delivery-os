import { LegalSection } from "@/components/legal/legal-shell"

/**
 * As 14 cláusulas do Contrato de Prestação de Serviços, num lugar só.
 *
 * Duas páginas mostram este texto: o contrato público (/contrato) e o Termo
 * de Adesão de cada cliente (/contrato/adesao/<token>), que o reproduz na
 * íntegra. É o mesmo componente nas duas de propósito — com uma cópia em cada
 * uma, bastaria alguém corrigir uma vírgula numa só pra existir "o contrato do
 * site" e "o contrato do termo", e o cliente assinaria um que não é o outro.
 *
 * ⚠️ Mudou o texto? Suba `CONTRATO_VERSAO` e `CONTRATO_ATUALIZADO_EM` em
 * `lib/contrato-adesao-texto.ts`. A cláusula 14.1 obriga avisar os clientes
 * com 30 dias de antecedência — mexer aqui é ato jurídico, não edição.
 */
export function ContratoClausulas() {
  return (
    <>
