...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    date: "2026-09-17",
    tag: "Correção",
    title: "Nino AI não confunde mais \u201cnão carregou\u201d com \u201cnão vendeu\u201d",
    summary:
      "Quando o histórico de um mês não carregava, o Nino recebia o mês sem o iFood e tirava conclusões em cima disso. Agora ele avisa que o número não veio.",
    areas: [
      {
        area: "Nino AI",
        items: [
