                ...
                <button type="button" onClick={() => setEditing(e)} className="flex min-w-0 flex-1 items-center gap-3 text-left">
                  ...
                  <div className="min-w-0 flex-1">
                    <div
                      ...
                      /* O texto original fica no hover: o histórico do extrato
                         é documento, e quem for conferir com o banco precisa
                         dele caractere a caractere. */
                      title={e.titular || e.description || cat?.name || undefined}
                    >
                      {semCaps(e.titular || e.description || cat?.name || "Lançamento")}
                    </div>
 ...
 *
 * ⚠️ NÃO altera o dado, só a exibição — o texto original vai no `title` da
 * linha. O histórico do extrato é documento: quem for conferir com o banco
 ...
 */
function semCaps(texto: string): string {
