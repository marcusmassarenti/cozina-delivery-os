  ...
  if (isSelf) {
    return (
      <button
        type="button"
        disabled
        aria-label="Não é possível deletar a si mesmo"
        title="Você não pode deletar a si mesmo"
        className="flex size-8 cursor-not-allowed items-center justify-center rounded-md text-muted-foreground/40"
      >
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <strong>{userName ?? userEmail}</strong>. Essa ação remove o acesso
            ao sistema permanentemente. Não pode ser desfeita.
          </AlertDialogDescription>
        </AlertDialogHeader>
        {err && (
